...
const FRAMEWORK_DECORATORS: Record<string, string[]> = {
  // NestJS
  '@nestjs/common': [
    'Injectable',
    'Controller',
...
export const DecoratorRetainer: GraphMutator = {
...
function getDecoratorName(decorator: Node): string {
  if (!Node.isDecorator(decorator)) return ''
...
function shouldRetain(decoratorName: string, customDecorators: Set<string>): boolean {
