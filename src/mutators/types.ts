 ...
 */
export type MutatorPhase =
  | 'entry-points'  // Mark entry points (first)
  | 'references'    // Build additional reference edges
  | 'retention'     // Mark symbols to retain regardless of references
  | 'marking'       // Final used/unused traversal (last)
