 ...
 */
export function detectAssignOnlyProps(project, options = {}) {
    const issues = [];
 ...
 */
function analyzePropertyUsage(cls, propName) {
    const usage = {
        readCount: 0,
        writeCount: 0,
        readLocations: [],
 ...
 */
function isWriteContext(node, parent) {
 ...
 */
function hasIgnoredDecorator(prop, ignoreDecorators) {
 ...
 */
function determineConfidence(prop, usage) {
...
//# sourceMappingURL=AssignOnlyProps.js.map