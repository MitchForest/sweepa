 ...
 */
export type SymbolKind = 'function' | 'class' | 'method' | 'property' | 'variable' | 'type' | 'interface' | 'enum' | 'enum-member' | 'namespace' | 'module' | 'parameter';
/**
 ...
 */
export type ReferenceType = 'call' | 'property-read' | 'property-write' | 'type-reference' | 'import' | 're-export' | 'instantiation' | 'decorator' | 'jsx-element' | 'interface-implementation';
/**
 ...
 */
export type ReferenceSource = 'same-file' | 'same-package' | 'different-package' | 'external';
